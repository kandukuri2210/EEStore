...
<html lang="en">
    ...
    <div style="margin:20px">
            <form action="../locations/mobile.php" method="POST">
  ...
  <tbody>
    <?php
$sql="Select * from `crud` where category='Electronic' and product='Mobile'";
...
if($result){
    while( $row=mysqli_fetch_assoc($result)){
        ...
        <td>$category</td>
        <td>$product</td>
        <td><a href='../productdetails/mobile.php' target='_top'>More</a></td>
