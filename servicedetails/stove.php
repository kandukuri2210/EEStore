...
<html lang="en">
    ...
    <div style="margin:20px">
            <form action="../locations/stove.php" method="POST">
                <input type="text" name="loc" placeholder="Search for your location..">
  ...
  <tbody>
    <?php
$sql="Select * from `crud` where category='Electric' and product='stove'";
...
if($result){
    while( $row=mysqli_fetch_assoc($result)){
        ...
        <td>$category</td>
        <td>$product</td>
        <td><a href='../productdetails/stove.php' target='_top'>More</a></td>
