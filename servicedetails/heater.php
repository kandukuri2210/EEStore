...
<html lang="en">
    ...
    <div style="margin:20px">
            <form action="../locations/heater.php" method="POST">
  ...
  <tbody>
    <?php
$sql="Select * from `crud` where category='Electric' and product='heater'";
...
if($result){
    while( $row=mysqli_fetch_assoc($result)){
        ...
        <td>$category</td>
        <td>$product</td>
        <td><a href='../productdetails/heater.php' target='_top'>More</a></td>
