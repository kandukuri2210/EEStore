...
<html lang="en">
    ...
    <div style="margin:20px">
            <form action="../locations/calculator.php" method="POST">
  ...
  <tbody>
    <?php
$sql="Select * from `crud` where category='Electric' and product='calculator'";
...
if($result){
    while( $row=mysqli_fetch_assoc($result)){
        ...
        <td>$category</td>
        <td>$product</td>
        <td><a href='../productdetails/calculator.php' target='_top'>More</a></td>
