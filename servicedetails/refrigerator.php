...
<html lang="en">
    ...
    <div style="margin:20px">
            <form action="../locations/refrigerator.php" method="POST">
                <input type="text" name="loc" placeholder="Search your location here..">
  ...
  <tbody>
    <?php
$sql="Select * from `crud` where category='Electronic' and product='refrigerator'";
...
if($result){
    while( $row=mysqli_fetch_assoc($result)){
        ...
        <td>$category</td>
        <td>$product</td>
        <td><a href='../productdetails/refrigerator.php' target='_top'>More</a></td>
