<html>
    ...
    <body>
        <h1><marquee>Welcome to Bulb Service Center</marquee></h1>
        <div class="container">
            <div class="image">
                <img class="loc" src="../images/bulb-service.jpg" alt="Maps nearby" width="90%"/>
            </div>
            <div class="s1">
                <a href="https://www.indiamart.com/proddetail/led-street-repairing-service-1927156233.html" title="India Mart" targrt="_top">Light Services</a>
                <p>The Indian mart offers various services for led lights,DJ lights, Ot Light Repairing Services.</p>
                    <ul>
                        <li>We provide anti rust housing structure</li>
                        <li>Optimum thermal management</li>
                        <li>Highly efficient constant current LED drivers</li>
                        <li>Short circuit and open circuit protection</li>
                        <li>Warm up or Cold start problem</li>
                        <li>Installation problems</li>
                    </ul>  
                    <div>
                        <img class="log" src="../images/bulb-service.jpg" alt="company" width="100%" height="50%"/>
                    </div>
                    <p class="info">India Mart offers sustainable energy solutions for lighting needs. These services are best in class and are easily affordable. For any query contact <br> <img class="one" src="images/phone.jpg" alt="Contact"  float="left"><span style="font-size:15px;">8686585108</span></p>
            </div>
          <!----  <div class="s2">
