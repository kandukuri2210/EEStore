<html>
    ...
    <body>
        <h1><marquee>Welcome to Stove Service Center</marquee></h1>
        <div class="container">
            <div class="image">
                <img class="loc" src="../images/stove-service.jpg" alt="Maps nearby" width="90%"/>
            </div>
            <div class="s1">
                <a href="https://www.atozservice.in/kurnool/kaff-gas-stove-repair-service.html" title="Kaff-Gas Stove Service" targrt="_top">Kaff Gas-Stove and Repair Services</a>
                <p>Kaff Gas stove Repair & Services Customer care number. We provide all type of Kaff Gas stove works like</p>
                    <ul>
                    ...
                    <div>
                        <img class="log" src="../images/stove-service.jpg" alt="company" width="100%" height="50%"/>
                    </div>
                    <p class="info">We have all type of Kaff Gas stove spareparts. For any query contact <br> <img class="one" src="images/phone.jpg" alt="Contact"  float="left"><span style="font-size:15px;">8686585108</span></p>
            </div>
          <!----  <div class="s2">
