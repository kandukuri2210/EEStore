<html>
    ...
    <body>
        <h1><marquee>Welcome to Mobile Service Center</marquee></h1>
        <div class="container">
            <div class="image">
                <img class="loc" src="../images/mobile-service.jpg" alt="Maps nearby" width="90%"/>
            </div>
            <div class="s1">
                <a href="mobile.html" title="Mobile Repair" targrt="_top">Services for mobile</a>
                <p>The mobile devices are quite common usage appliance. Irrespective of age every one is using this mobile device. So there are some complications that are being encountered. So from our portal we would like to offer services for mobile devices like Realme, Redmi, Oppo, One Plus.The following services are being rendered.</p>
                    <ul>
                        <li>The automatic shut down of mobile</li>
                        <li>Mobile Hanging</li>
                        <li>Drain in Charging</li>
                        <li>Unable to open Google browser</li>
                        <li>The sound is not audible</li>
                        <li>Unable to make phone calls</li>
                        <li>Display issues</li>
                        <li>Battery is enlarged</li>
                        <li>No proper video clarity</li>
                        <li>OS Installation</li>
                        <li>Camera is not working</li>
                        <li>Over heating of mobile even in less usage</li>
                    </ul>  
                    <div>
                        <img class="log" src="../images/mobile-service.jpg" alt="company" width="100%" height="50%"/>
                    </div>
                    <p class="info">We have all the above services being rendered by professionals. The professionals are well educated and are computer engineers with knowledge on mobile communications. Customer satisfaction is our main motto. For any query contact <br> <img class="one" src="images/phone.jpg" alt="Contact"  float="left"><span style="font-size:15px;">8686585108</span></p>
            </div>
          <!----  <div class="s2">
