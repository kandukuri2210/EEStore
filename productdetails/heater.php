<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="image">
                <img class="loc" src="../images/heater-service.jpg" alt="Maps nearby" width="90%"/>
            </div>
            <div class="s1">
                <a href="https://www.threspruce.com" title="Heater Service Store" targrt="_top">Heater Services</a>
                <p>We offer the following services on heater</p>
                    <ul>
                        <li>Failed heating element</li>
                        <li>No heat production</li>
                        <li>Installation of heater</li>
                        <li>Maintainance</li>
                        <li>Precautionary measures if service is rendered online mode</li>
                        <li>Water temperature is too hot</li>
                        <li>Water leaks</li>
                        <li>Rust-Coloured water</li>
                        <li>Tank making noises</li>
    
                    </ul>  
                    <div>
                        <img class="log" src="../images/heater-service.jpg" alt="company" width="100%" height="50%"/>
                    </div>
                    <p class="info">We have support for all the problems being faced for not heating water through water heater. For any query contact <br> <img class="one" src="images/phone.jpg" alt="Contact"  float="left"><span style="font-size:15px;">8686585108</span></p>
            </div>
          <!----  <div class="s2">
