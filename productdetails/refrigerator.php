<html>
    ...
    <body>
        <h1><marquee>Welcome to Refrigerator Service Center</marquee></h1>
        <div class="container">
            <div class="image">
                <img class="loc" src="../images/fride-service.jpg" alt="Maps nearby" width="90%"/>
            </div>
            <div class="s1">
                <a href="refrigerator.html" title="Refrigerator service" targrt="_top">Services for Refrigerator</a>
                <p>Maintaining the refrigerator is a tedious task. This is because of extent amount of heat release to make the commodoties safe and cool insode the container. So we need to service the refrigerator atleast twice a year.</p>
                    <ul>
                        <li>The services are as stated below</li>
                        <li>Cleaning Coils</li>
                        <li>Freezer is not cooling correctly</li>
                        <li>Checking Gaskets</li>
                        <li>Changing Filters</li>
                        <li>More Ice formation</li>
                        <li>Abnormal cooling</li>
                        <li>Replacement of Refrigerator</li>
                        <li>Refrigerator breakdown</li>
                        <li>Problem with the condenser coils</li>
                        <li>More water dripping</li>
                        <li>Blown fuse</li>
                    </ul>  
                    <div>
                        <img class="log" src="../images/fride-service.jpg" alt="company" width="100%" height="50%"/>
                    </div>
                    <p class="info">We have the above services rendered by well trined industrialists who have completed their course in best ITI's. For any query contact <br> <img class="one" src="images/phone.jpg" alt="Contact"  float="left"><span style="font-size:15px;">8686585108</span></p>
            </div>
          <!----  <div class="s2">
