<html>
    ...
    <body>
        <h1><marquee>Welcome to Grinder Service Center</marquee></h1>
        <div class="container">
            <div class="image">
                <img class="loc" src="../images/grinder-service.jpg" alt="Maps nearby" width="90%"/>
            </div>
            <div class="s1">
                <a href="https://www.sulekha.com" title="Grinder Service Store" targrt="_top">Grinder Services</a>
                <p>We offer services for grinder as follows</p>
                    <ul>
                        <li>Grinder Installation</li>
                        <li>Issue with motor</li>
                        <li>Not grinding fine</li>
                        <li>Consuming more electricity</li>
                        <li>Taking more time to grind</li>
                        <li>The services are extended to various company products like</li>
                        <li>Prestige</li>
                        <li>Butterfly</li>
                        <li>Pigeon</li>
                    </ul>  
                    ...
                    <p class="info">For any query contact <br> <img class="one" src="images/phone.jpg" alt="Contact"  float="left"><span style="font-size:15px;">8686585108</span></p>
            </div>
          <!----  <div class="s2">
