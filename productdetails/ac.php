<html>
    ...
    <body>
        <h1><marquee>Welcome to AC Service Center</marquee></h1>
        <div class="container">
            <div class="image">
                <img class="loc" src="../images/ac-service.jpg" alt="Maps nearby" width="90%"/>
            </div>
            <div class="s1">
                <a href="https://www.mrright.in/ideas/appliances/ac/how-is-ac-service-done" title="Mishra AC Service Center" targrt="_top">AC Service Center</a>
                <p>Services being offered from Mishra AC Service Center</p>
                    <ul>
                        ...
                        <li>Over all inspection of AC Unit</li>
                    </ul>  
                    <div>
                        <img class="log"src="../images/ac-service.jpg" alt="company" width="100%" height="50%"/>
                    </div>
                    <p class="info">We have services for different kinds of ac's like <strong>Voltas, Blue Star, Whirlpool</strong>For any query contact<br> <img class="one" src="images/phone.jpg" alt="Contact"  float="left"><span style="font-size:15px;">8686585108</span></p>
            </div>
          <!----  <div class="s2">
