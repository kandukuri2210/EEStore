<html>
    ...
    <body>
        <h1><marquee>Welcome to Speaker Service Center</marquee></h1>
        <div class="container">
            <div class="image">
                <img class="loc" src="../images/speaker-service.jpg" alt="Maps nearby" width="90%"/>
            </div>
            <div class="s1">
                <a href="speaker.html" title="Speaker Services" targrt="_top">Speaker Repair Services</a>
                <p>Speakers are mostly used in wide crowd areas so we should service this to make the audio clear and noise less. The following services are provided in the store.</p>
                    <ul>
                        <li>Enclosure Damage</li>
                        <li>Electrical blow</li>
                        <li>Thermal fuse</li>
                        <li>Faulty wiring</li>
                        <li>Fault in voice coil</li>
                        <li>Crossover network Faults</li>
                        <li>Problem with solder connection</li>
                        <li>Outphase of speakers</li>
                        <li>Speaker replacement</li>
                    </ul>  
                    <div>
                        <img class="log" src="../images/speaker-service.jpg" alt="company" width="100%" height="50%"/>
                    </div>
                    <p class="info">We have all the above mentioned services for speakers at home services or service at shop. For any query contact <br> <img class="one" src="images/phone.jpg" alt="Contact"  float="left"><span style="font-size:15px;">8686585108</span></p>
            </div>
          <!----  <div class="s2">
