<html>
    ...
    <body>
        <h1><marquee>Welcome to Calc Service Center</marquee></h1>
        <div class="container">
            <div class="image">
                <img class="loc" src="../images/calc-service.jpg" alt="Maps nearby" width="90%"/>
            </div>
            <div class="s1">
                <a href="https://www.ifixit.com/Device/Calculator" title="Calc Service" targrt="_top">Ifix it Services</a>
                <p>Ifix it offers services for twenty different categories of calculators. There are three major types of calculators as basic, scientific, and graphic. The following services are being rendered through our store:</p>
                    <ul>
                        <li>Battery Replacement</li>
                        <li>Tear downs</li>
                        <li>Calculator won't turn on</li>
                        <li>Calculator buttons won't work</li>
                        <li>Not working</li>
                        <li>No display</li>
                        <li>Advices based on condition of calculator like it should be replaced or changed or buy a new one</li>
                        
                    </ul>  
                    <div>
                        <img class="log" src="../images/calc-service.jpg" alt="company" width="100%" height="50%"/>
                    </div>
                    <p class="info">We offer the best services for any kind of calculator with warranty issued. For any query contact <br> <img class="one" src="images/phone.jpg" alt="Contact"  float="left"><span style="font-size:15px;">8686585108</span></p>
            </div>
          <!----  <div class="s2">
